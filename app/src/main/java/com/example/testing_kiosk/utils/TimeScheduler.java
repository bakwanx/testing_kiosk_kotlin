 ...
 * method {@link Task#nextInterval()} needs to be implemented.
 * </ul>
 * 
 */
public interface TimeScheduler {
     ...
     * ({@link TimeScheduler#scheduleWithDynamicInterval(Task)}) must implement */
     ...
     * {@link Task#nextInterval()} milliseconds. The task is never done until
